...
// was void, became Napi::Object because NAPI requires us to explicitely return the
// now filled `exports` object

Napi::Object Initialize(Napi::Env env, Napi::Object exports) {
  skbinding::AddFunction(env, exports, "runWithGC", skbinding::RunWithGC);
  skbinding::AddFunction(env, exports, "getErrorObject", skbinding::GetErrorObject);
  ...
  skbinding::AddFunction(env, exports, "initSkipRuntimeToBinding", InitToBinding);
  return exports;
}
